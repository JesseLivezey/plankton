...
class SemiNORB(SemiSupervised):
    ...
    def __init__(self, which_norb, which_set, image_dtype='uint8'):
        ...
        super(SemiNORB, self).__init__(X=images,
                                   V=images,
                                   L=images,
                                   y=labels,
    ...
    @functools.wraps(SemiSupervised.get_topological_view)
    def get_topological_view(self, mat=None, single_tensor=False):
        ...
        result = super(SemiNORB, self).get_topological_view(mat)
